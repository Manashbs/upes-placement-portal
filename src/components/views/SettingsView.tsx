...
export const SettingsView: React.FC = () => {
  ...
  const handleDeleteUser = (id: string, name: string) => {
    if (id === currentUser?.id || id === 'usr-cso' || id === 'usr-director-manash' || name.toLowerCase().includes('cso') || name.toLowerCase().includes('manash')) {
      alert('Cannot delete the primary CSO account.');
      return;
    }
