...
export const RoundDetailsModal: React.FC<RoundDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 overflow-y-auto select-none">
      <div className="bg-white rounded-3xl max-w-3xl w-full p-6 shadow-2xl space-y-6 border border-slate-100 my-8">
        {/* Top Header */}
          ...
          {currentRoundStudents.length > 0 ? (
            <div className="border border-slate-100 rounded-2xl overflow-hidden max-h-44 overflow-y-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-50 text-slate-400 font-extrabold uppercase tracking-wider text-[10px]">
                  <tr>
